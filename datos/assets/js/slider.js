...
$(document).ready(function(){
    ...
    $('#news-carousel').slick({
        slidesToShow: 1,
        prevArrow: '<div class="carousel-control-prev-container"><i class="fa fa-angle-left"></i></div>',
        nextArrow: '<div class="carousel-control-next-container"><i class="fa fa-angle-right"></i></div>',      
          responsive: [
        {
          breakpoint: 768,
          settings: {
