...
function rop_plugin_meta( $links, $file ) { // add some links to plugin meta row
	if ( strpos( $file, 'republish-old-posts.php' ) !== false ) {
		...
		$links = array_merge( $links, array( '<a href="http://infolific.com/technology/software-worth-using/republish-old-posts-for-wordpress/#pro-version" target="_blank">Pro Version (less than $10)</a>' ) );
	}
...
function rop_options_page() {	 	
	...
	<div class="wrap" style="padding-bottom: 5em">
		...
		<p>More options are available in the <a href="http://infolific.com/technology/software-worth-using/republish-old-posts-for-wordpress/#pro-version" target="_blank">pro version</a> (less than $10).</p>
