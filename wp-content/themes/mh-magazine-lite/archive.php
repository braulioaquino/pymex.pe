...
$(function(){
	$('#clickButton').on('click', function(){
		var ruc = $('#ruc').val();
		var url = 'https://pymex.com/wp-content/themes/mh-magazine-lite/consultaSunat.php';
...
.ajaxgif{position:absolute; bottom:12px; right:-20px;}
.hide{display:none;}
.caja1 {width:700px; margin: auto;}
.imput-design{
  width: 100%;
